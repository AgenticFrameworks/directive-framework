...
1. AUTHOR     Copy ED-TEMPLATE.md -> ED-<id>.md. Pick tier (FULL | CEREMONY), state it.
              Run every risky operation NOW (probes), paste real outputs into the ED.
              Put the actual implementation files in ED-<id>.files/ — the executor
...
{"id":"ED-001","state":"GREENLIT","ts":"...","authoring_wallclock_min":40}
...
States: `DESIGN | VETTED | GREENLIT | BUILT-GREEN | BUILT-RED | VERIFIED`.
