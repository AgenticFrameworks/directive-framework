...
DEFAULT_REGISTRY = os.path.abspath(os.path.join(HERE, "..", "_directives", "registry.jsonl"))
DEFAULT_README = None  # ED-003: computed as <registry-dir>/dashboard.md; canon README is never a dashboard target
...
def main():
    ...
    ap.add_argument("--readme", default=DEFAULT_README,
                    help="dashboard host file with the marker pair (default: dashboard.md "
                         "next to the registry; created with a marker skeleton if missing)")
